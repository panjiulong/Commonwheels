...
class TransitionAnimation: UIPercentDrivenInteractiveTransition, UIViewControllerAnimatedTransitioning {
    ...
    func pushAnimation(transitionContext:UIViewControllerContextTransitioning) {
        ...
        if transitionContext.viewController(forKey: UITransitionContextViewControllerKey.from) is BaseNavigationController {
            let baseNav = transitionContext.viewController(forKey: UITransitionContextViewControllerKey.from) as? BaseNavigationController
